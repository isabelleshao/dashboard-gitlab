<template>
    <div class = "issues">
        <div class = "rightsided">
            ...
            <br/>
            <a target="_blank" v-bind:href='this.project.web_url+"/-/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D="'>
                <div class = "container_create">
                    <img class = "create_icon" src='../../../../public/create.png' alt = "create image"/>
